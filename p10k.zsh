# Generated by Powerlevel10k configuration wizard on 2021-06-10 at 15:52 CDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 51222.
# Wizard options: powerline, unicode, lean_8colors, 12h time, 2 lines, dotted, no frame,
# white-ornaments, compact, concise, transient_prompt, instant_prompt=verbose.
